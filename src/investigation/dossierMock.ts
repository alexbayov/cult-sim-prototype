...
export const dossierMock: Case = {
  ...
  subtitle: 'Материалы · бесплатный поток, обещание дисциплины и нового окружения',
  status: 'в работе',
  publicLegend:
    'Открытый марафон. Публично: поддержка, сильное окружение, выход из выгорания за 8 недель.',
  investigationQuestion:
    'Это токсичный инфобизнес — или складывающаяся система давления и зависимости?',
  riskStatement:
    'Активные участники: 6 опрошенных, 1 в высокой группе риска. Денежное давление зафиксировано в чате недели 3.',
  contentWarning:
    'Материалы вымышленные. Описания психологического давления и денежного принуждения даются косвенно.',
  progressChips: [
    { label: 'источники', value: '6 / 12' },
    { label: 'закладки', value: '4 / ≈40' },
    { label: 'наблюдения', value: '2 подтв. / 6' },
  ...
  evidence: [
    {
      ...
      linkedPatternTitle: 'сужение внешних связей',
      reliability: 'high',
      weight: 'high',
    },
    {
      ...
      linkedPatternTitle: 'денежное давление',
      reliability: 'high',
      weight: 'high',
    },
    {
      ...
      linkedPatternTitle: 'резкое сближение',
      reliability: 'medium',
      weight: 'medium',
    },
    {
      ...
      sourceLabel: 'показания: Света Д.',
      linkedPatternTitle: 'свой язык группы',
      reliability: 'medium',
      weight: 'medium',
    },
  ],
  patterns: [
    ...
    {
      id: 'isolation',
      title: 'сужение внешних связей',
      status: 'confirmed',
      shortDescription: 'Людей и привычки вне группы мягко вытесняют как «помеху».',
      evidenceCount: 2,
      requiredEvidence: 2,
    },
    {
      id: 'loaded-language',
      title: 'свой язык группы',
      status: 'supported',
    ...
    },
    {
      ...
      status: 'confirmed',
      shortDescription: 'Платежи без возврата, нарастающие суммы внутри потока.',
      evidenceCount: 2,
      requiredEvidence: 2,
    },
    {
      id: 'coercive-control',
      title: 'тихое давление',
      status: 'suspected',
      shortDescription: 'Поведением управляют через страх потерять группу и статус.',
      evidenceCount: 1,
      requiredEvidence: 3,
    },
    {
      id: 'dependency-loop',
      title: 'зависимость от группы',
      status: 'unknown',
      shortDescription: 'Сначала состояние обостряется, затем группа предлагает себя как решение.',
      evidenceCount: 0,
      requiredEvidence: 3,
    },
  ],
